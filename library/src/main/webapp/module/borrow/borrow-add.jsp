...
<title>添加借书信息 - H-ui.admin v3.0</title>
</head>
<body>
<article class="page-container"><!-- onsubmit="return addUser();" -->
	<form action="javascript:void(0);" method="post" class="form form-horizontal" id="form-borrow-add">
		<div class="row cl">
...
<!-- 自定义js -->
<script type="text/javascript" src="js/borrow-add.js"></script>
<!--/请在上方写此页面业务相关的脚本-->
</body>
</html>
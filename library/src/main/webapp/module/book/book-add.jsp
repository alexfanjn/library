...
<title>添加图书 - H-ui.admin v3.0</title>
</head>
<body>
<article class="page-container"><!-- onsubmit="return addBook();" -->
	<form action="javascript:void(0);" method="post" class="form form-horizontal" id="form-book-add">
		<div class="row cl">
...
<!-- 自定义js -->
<script type="text/javascript" src="js/book-add.js"></script>
<!--/请在上方写此页面业务相关的脚本-->
</body>
</html>
...
<title>更新图书 - H-ui.admin v3.0</title>
</head>
<body>
<article class="page-container">
	<form action="javascript:void(0);" method="post" class="form form-horizontal" id="form-book-update">
		<!-- 隐藏id -->
		<input type="hidden" name="id" value="${book.id }">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>书名：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${book.bookName }" id="bookName" name="bookName">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>地址：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${book.location }" id="location" name="location">
			</div>
		</div>
		<div class="row cl">
...
<!-- 自定义js -->
<script type="text/javascript" src="/library/module/book/js/book-update.js"></script>
<!--/请在上方写此页面业务相关的脚本-->
</body>
</html>